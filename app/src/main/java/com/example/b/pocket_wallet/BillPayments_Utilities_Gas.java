...
public class BillPayments_Utilities_Gas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__gas);
    ...
    private void attemptNextPage() {
        ...
        {
            Intent intent = new Intent(getApplicationContext(),BillPayments_Utilities_Gas_Confirmation.class);

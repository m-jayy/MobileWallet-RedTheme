...
public class BillPayments_Utilities_Electricity_Confirmation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__electricity__confirmation);
        ...
        refNumber_str = getIntent().getStringExtra("refNum");

...
public class BillPayments_Utilities_Electricity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__electricity);
    ...
    private void attemptNextPage() {
        ...
        {
            Intent intent = new Intent(getApplicationContext(),BillPayments_Utilities_Electricity_Confirmation.class);
            intent.putExtra("refNum",refNum_Handler.getText().toString());

...
public class BillPayments_Utilities_Water extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__water);
    ...
    private void attemptNextPage() {
        ...
        {
            Intent intent = new Intent(getApplicationContext(),BillPayments_Utilities_Water_Confirmation.class);

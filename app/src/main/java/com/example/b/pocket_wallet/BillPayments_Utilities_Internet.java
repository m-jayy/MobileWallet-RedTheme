...
public class BillPayments_Utilities_Internet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__internet);
    ...
    private void attemptNextPage() {
        ...
        {
            Intent intent = new Intent(getApplicationContext(),Billpayments_Utilities_Internet_Confirmation.class);
            intent.putExtra("CustomerID",refNum_Handler.getText().toString());

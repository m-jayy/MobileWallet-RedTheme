...
public class Billpayments_Utilities_Internet_Confirmation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__internet__confirmation);
        ...
        refNumber_str = getIntent().getStringExtra("CustomerID");

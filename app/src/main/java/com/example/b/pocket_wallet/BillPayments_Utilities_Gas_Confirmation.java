...
public class BillPayments_Utilities_Gas_Confirmation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_billpayments__utilities__gas__confirmation);
